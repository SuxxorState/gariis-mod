...
function onCreate()
    ...
    setProperty("carv.scrollFactor.x", 0.99)
    setProperty("carv.scrollFactor.y", 0.99)
    setProperty("hunte.scrollFactor.x", 0.99)
    setProperty("hunte.scrollFactor.y", 0.99)
...
function onEventPushed(name, value1, value2, strumTime)
    ...
    if (event == "goons fall") then
        ...
        setProperty("truckergf-looney.scrollFactor.x", 0.99)
        setProperty("truckergf-looney.scrollFactor.y", 0.99)
